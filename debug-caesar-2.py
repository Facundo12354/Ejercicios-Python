...
def encryptMessage(message, cipherKey, alphabet):
    encryptedMessage = ""
    uppercaseMessage = message.upper()  # Convert the message to uppercase once
...
#The bug in the program is in the encryptMessage function. The uppercaseMessage variable is assigned the value of message twice, and the first assignment is unnecessary.
