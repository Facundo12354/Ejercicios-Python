...
#The bug in the program is in the decryptMessage function. The decryptKey should be passed to the encryptMessage function instead of the original cipherKey.